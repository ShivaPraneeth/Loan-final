	...
	<div id="main">
		...
		<div id="site_content">
			...
			<div id="content">
				...
				<form action="AddBankServlet" name="ff" method="post"
					onsubmit="return check()">
		
					<div class="form_settings">
						<p>
							<span>Bank Id</span><input class="contact" type="text" placeholder="enter Bank Id"
								name="username" required>
						</p>
						<p> <span> Name </span><input class="contact" type="text" placeholder="enter name" name="name" onkeypress="return check_alpha(event)" autocomplete="off" required>
				  <p id="name_error" style="color:red;align:center"></p></p>
